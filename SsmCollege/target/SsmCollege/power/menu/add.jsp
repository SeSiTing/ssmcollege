...
<body>
		...
		<div class="div_head">
            ...
            <div class="cztable">
            <form action="/menu/string/addmenu" method="post">
				...
				<tr  width="120px;">
                    ...
                    <td>
                    	<select  name="upmenuid">
                            ...
                            <c:forEach items="${flist}" var="menu">
                ...
                <tr  width="120px;">
                    ...
                    <td>
						<input type="text"  name="menupath" value="" />
					</td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <input type="radio" name="menustate" checked value="1" />启用 <input type="radio" name="namestate" value="0"/>禁用
                    </td>
                </tr>
