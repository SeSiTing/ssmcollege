    ...
    <form action="../right.jsp" method="post">
        <table border="1" width="100%" class="table_a">
            <tr>
                ...
                <td><input type="text" name="informationid" value="${info.informationid}" /></td>
            </tr>
            <tr>
                <td>资料名称 ：<span style="color:red">*</span>：</td>
                <td>
                    <input type="text" name="informationname" value="${info.informationname}" />
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <select name="typeid">
                        <c:forEach items="${typelist}" var="t">
                            <option value="${t.infoid}" <c:if test="${t.infoid==typeid}">selected</c:if>>${t.infotype}</option>
                        </c:forEach>
                    </select>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <input type="text" name="date" value="<fmt:formatDate value="${info.date}" pattern="yyyy/MM/dd"/> " /></td>
            </tr>
            <tr>
                <td>格式：<span style="color:red">*</span>：</td>
                <td>
                    <input type="text" name="filetype" value="${info.filetype}" /></td>
            </tr>
            <tr>
                <td>上传人：<span style="color:red">*</span>：</td>
                <td>
                    <input type="text" name="uploader" value="${info.uploader}" /></td>
            </tr>
            <tr>
