...
<div class="div_head" style="width: 100%;text-align:center;">
            <span>
                ...
                <span style="float:right;margin-right: 8px;font-weight: bold">
                	<a style="text-decoration: none" href="/information/string/getalltype">【上传】</a> &emsp;
...
<div class="fllist">
    <form action="/information/string/getallinfo">
        ...
        <ul>
            <li>
                ...
                <input type="text" name="informationname" ${informationname}/>&nbsp;&nbsp;<input type="submit"
                                                                                                 value="搜索"/>
            </li>
            <li><strong>类型：</strong><a href="/information/string/getallinfo" id="tAll">全部</a>

                <a href="/information/string/getallinfo?typeid=1" id="1">
                    复习资料</a>

                <a href="/information/string/getallinfo?typeid=2" id="2">
                    练习题</a>

                <a href="/information/string/getallinfo?typeid=3" id="3">
                    内部资料</a>

                <a href="/information/string/getallinfo?typeid=4" id="4">
                    真题</a>
    ...
    <div class="cztable">
        <table width="100%" border="0" cellspacing="0" cellpadding="0" style="text-align:center;">
            ...
            <c:forEach items="${pi.list}" var="info">
                <tr>
                    ...
                    <td>
                        <fmt:formatDate value="${info.date}" pattern="yyyy-MM-dd"/>

                    </td>
                    <td>
                        <a href="/information/string/getoneinfo?informationid=${info.informationid}&typeid=${info.typeid}">详情</a>
                        <a href="/information/string/updateinfo?informationid=${info.informationid}&typeid=${info.typeid}">编辑</a>
                    </td>
                </tr>
            </c:forEach>
        ...
        <div class='MainStyle'>
            ...
            <div class=''><a href='http://sm.zk0731.com/OnlineTeaching/StudentMaterial.aspx?page=2' target='_self'>2</a>
            </div>
            <div class=''><a href='http://sm.zk0731.com/OnlineTeaching/StudentMaterial.aspx?page=3' target='_self'>3</a>
            </div>
