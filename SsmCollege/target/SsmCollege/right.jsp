    ...
    %>
        ...
        <table cellspacing=0 cellpadding=2 width="95%" align=center border=0>
            ...
            <tr>
                ...
                <td style="color: #880000"><fmt:formatDate value="${u1.regdate}" pattern="yyyy-MM-dd HH:mm:ss"/></td></tr>
            <tr>
            ...
            <tr>
                ...
                <td style="color: #880000">
                    <input type="text" name="wea"/><span></span>
                </td></tr>

            <script>
                $(function(){
                    $("[name=wea]").blur(function(){
                        var ads= $(this).val();
                        $.ajax({
                            url:"getweather",
                            data:{address:ads},
