...
<div class="cztable">
    <form action="/infomation/string/upload" method="post" enctype="multipart/form-data">
	<table border="1" width="100%" class="table_a">
                <tr>
                    <td width="120px;">编号：<span style="color:red">*</span>：</td>
                    <td><input type="text" name="informationid" value="" /></td>
                </tr>
                <tr>
                ...
                <tr>
                   ...
                   <c:forEach items="${typelist}" var="t">
                       <option value="${t.infoid}">${t.infotype}</option>
                   </c:forEach>
                    </select>	
                    </td>
                </tr>
                <tr>
				 ...
				 <tr>
                    ...
                    <td>
						<input type="text" name="filetype" value="" /></td>
                </tr>
                <tr>
                    <td>上传人：<span style="color:red">*</span>：</td>
                    <td>
						<input type="text" name="uploader" value="" /></td>
                </tr>
				<tr>
