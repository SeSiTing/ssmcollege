...
<table border="1" width="100%" class="table_a">
                ...
                <tr  width="120px;">
                    ...
                    <td>
						<ul>
                            <c:forEach items="${role.menus}" var="menu1" varStatus="sta">
                        	<li><span>${sta.count}.${menu1.menuname}</span>
                            	<ul>
                ...
                <tr>
                    ...
                    <td>&nbsp;&nbsp;&nbsp;&nbsp;
                        <c:if test="${role.rolestate==1}"> <span>启用</span></c:if>
                        <c:if test="${role.rolestate==0}"> <span>禁用</span></c:if>
                    </td>
                </tr>
